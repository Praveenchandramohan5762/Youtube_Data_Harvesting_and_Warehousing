...
#API Key Connection
def API_Key_connect():
    API_Key = "AIzaSyDNAWQj3bijes4_luelVuLAiwWs0Tn2-9o"
    API_service_name = "youtube"
    API_version = "v3"
    youtube = build(API_service_name,API_version, developerKey = API_Key)
    return youtube

youtube = API_Key_connect()
...
client = pymongo.MongoClient("mongodb+srv://praveenmohan467:praveen@cluster0.degziry.mongodb.net/?retryWrites=true&w=majority")
